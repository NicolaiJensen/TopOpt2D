#ifndef __NONLINEARELASTICITY__
#define __NONLINEARELASTICITY__
...
public:
    // Constructor
    NonLinearElasticity(TopOpt *opt);
...
private:
    ...
    PetscInt  Quad4Isoparametric(PetscScalar *d, PetscScalar *X, PetscScalar *Y, PetscScalar nu, PetscInt AssType, PetscScalar *ke);
    PetscScalar Dot(PetscScalar *v1, PetscScalar *v2, PetscInt l);
    void  DifferentiatedShapeFunctions(PetscScalar xi, PetscScalar eta, PetscScalar *dNdxi, PetscScalar *dNdeta);
