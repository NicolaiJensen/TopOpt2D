...
class PDEFilt
{
	...
	KSP ksp; // linear solver
        ...
        void PDEFilterMatrix2D(PetscScalar dx, PetscScalar dy, 
			     PetscScalar RR,PetscScalar *KK, PetscScalar *T);
	
    
	
	void DifferentiatedShapeFunctions(PetscScalar xi, PetscScalar eta, PetscScalar FLxi, PetscScalar FLeta, PetscScalar *dNdxi, PetscScalar *dNdeta);
	
	void ShapeFunctions(PetscScalar xi, PetscScalar eta, PetscScalar FLxi, PetscScalar FLeta, PetscScalar *NN);
